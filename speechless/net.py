...
class Wav2Letter:
    ...
    def train(self,
        ...
        numpy.save('labels.npy', [x.label for x in input_batch[0]])
        input_batch_input, prediction_lengths = self._input_batch_and_prediction_lengths(numpy.array(input_batch))
